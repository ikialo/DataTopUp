...
import com.synarc.app.datatopup.Fragments.PrepaidPassesTabBemobile;
import com.synarc.app.datatopup.Fragments.TabData;
import com.synarc.app.datatopup.Fragments.TabDataBemobile;

import java.io.UnsupportedEncodingException;
import java.net.URLEncoder;

public class Bemobile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bemobile);
        viewPager = (ViewPager) findViewById(R.id.viewPagerb);
        tabLayout = (TabLayout) findViewById(R.id.tabLayoutb);
        adapter = new TabAdapter(getSupportFragmentManager());
        adapter.addFragment(new TabDataBemobile(), "Cheap Data ");
        adapter.addFragment(new PrepaidPassesTabBemobile(), "Prepaid Pass");
        viewPager.setAdapter(adapter);
        tabLayout.setupWithViewPager(viewPager);
    }


//    private static final int MY_PERMISSIONS_REQUEST_CALL_PHONE= 454;
...
//                ActivityCompat.requestPermissions(Bemobile.this,
